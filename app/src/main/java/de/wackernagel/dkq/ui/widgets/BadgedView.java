...
public class BadgedView extends View {
    ...
    public BadgedView(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        init( context, attrs );
    }
    ...
    private void init( final Context context, final AttributeSet attrs) {
        if( attrs != null ) {
            final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.BadgedView, 0, 0);
            badgeGravity = a.getInt(R.styleable.BadgedView_badgeGravity, badgeGravity );
            badgePadding = a.getDimensionPixelSize(R.styleable.BadgedView_badgePadding, badgePadding);
            final String text = a.getString(R.styleable.BadgedView_badgeText);
            badgeText = text != null ? text : badgeText;
            badgeColor = a.getColor(R.styleable.BadgedView_badgeColor, badgeColor);
            a.recycle();
        }
